<form id="formularioItens" method="POST" action="{{ route('site.cadastraEventos') }}">
    @csrf
    ...
    <div class="form-group row">
        ...
        <div class="col-md-9">
            <input required="required" class="form-control" type="date" id="iniciodata" placeholder="Data de início do evento" name="iniciodata">
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-md-9">
            <input required="required" class="form-control" type="date" id="fimdata" placeholder="Data de término" name="fimdata">
        </div>
    </div>
